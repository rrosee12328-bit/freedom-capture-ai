...
begin
  ...
  if new.qualification_status = 'Qualified' then
    ...
    applicant_cta := '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:28px 0"><tr><td style="border-radius:999px;background:#7c3aed"><a href="https://calendly.com/vektiss-info/30-minute-vektiss-discovery" style="display:inline-block;padding:14px 24px;color:#ffffff;font-size:16px;font-weight:700;text-decoration:none">Schedule Your Consultation&nbsp;&rarr;</a></td></tr></table>';
  ...
  applicant_html := '<!doctype html><html><body style="margin:0;padding:0;background:#f4f4f7;font-family:Arial,Helvetica,sans-serif;color:#202027"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding:24px 12px"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:620px;background:#ffffff;border-radius:18px;overflow:hidden;box-shadow:0 6px 24px rgba(20,20,35,.08)"><tr><td style="padding:32px 36px;background:#171727"><div style="color:#a78bfa;font-size:12px;font-weight:700;letter-spacing:2px">VEKTISS VOICE</div><h1 style="margin:10px 0 0;color:#ffffff;font-size:28px;line-height:1.2">Your application is in.</h1></td></tr><tr><td style="padding:36px"><h2 style="margin:0 0 18px;font-size:25px;line-height:1.25;color:#202027">Hey ' || safe_name || ' &#128075;</h2><p style="margin:0 0 18px;font-size:17px;line-height:1.7;color:#52525b">You took the first step toward capturing more serious leads without staying tied to the phone.</p><p style="margin:0;font-size:17px;line-height:1.7;color:#52525b">' || applicant_message || '</p>' || applicant_cta || '<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top:28px;background:#f7f5ff;border-radius:12px"><tr><td style="padding:18px 20px"><div style="font-size:13px;font-weight:700;color:#7c3aed;text-transform:uppercase;letter-spacing:1px">What happens next</div><div style="margin-top:8px;font-size:15px;line-height:1.6;color:#52525b">Keep an eye on your inbox and phone. If we need anything else, a member of the Vektiss team will reach out.</div></td></tr></table><p style="margin:30px 0 0;font-size:15px;line-height:1.6;color:#52525b">To more freedom,<br><strong style="color:#202027">The Vektiss Team</strong></p></td></tr><tr><td style="padding:20px 36px;background:#f8f8fa;color:#8a8a96;font-size:12px;line-height:1.6">Vektiss Technologies &middot; Automated lead capture and qualification<br>This email was sent because you submitted an application at Vektiss.</td></tr></table></td></tr></table></body></html>';

  admin_html := '<!doctype html><html><body style="margin:0;padding:0;background:#f4f4f7;font-family:Arial,Helvetica,sans-serif;color:#202027"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding:24px 12px"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:680px;background:#ffffff;border-radius:18px;overflow:hidden;box-shadow:0 6px 24px rgba(20,20,35,.08)"><tr><td style="padding:32px 36px;background:#171727"><div style="color:#a78bfa;font-size:12px;font-weight:700;letter-spacing:2px">VEKTISS LEAD ALERT</div><h1 style="margin:10px 0 18px;color:#ffffff;font-size:28px;line-height:1.25">&#128293; New Lead &mdash; ' || safe_name || '</h1><span style="display:inline-block;padding:9px 16px;border-radius:999px;background:' || status_color || ';color:#ffffff;font-size:12px;font-weight:800;letter-spacing:1px">' || status_label || '</span></td></tr><tr><td style="padding:32px 36px"><p style="margin:0 0 25px;color:#52525b;font-size:17px;line-height:1.65">A new lead submitted the Vektiss application and scored <strong style="color:#202027">' || new.qualification_status || ' (' || new.qualification_score || '/23)</strong>.</p><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse:collapse">' ||
    ...
    '<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin-top:26px"><tr><td style="border-radius:999px;background:#7c3aed"><a href="mailto:' || new.email || '?subject=Your Vektiss application" style="display:inline-block;padding:13px 22px;color:#ffffff;font-size:15px;font-weight:700;text-decoration:none">Reply to Lead&nbsp;&rarr;</a></td></tr></table></td></tr><tr><td style="padding:18px 36px;background:#f8f8fa;color:#8a8a96;font-size:12px">Source: ' || coalesce(new.lead_source, 'direct') || ' &middot; Lead ID: ' || new.id || '</td></tr></table></td></tr></table></body></html>';
